 ...
 *   date                    modification
 *   180713					 modified build parameter because dir_pttn, file_pttn
is moved dependency to job_tgt_dir
--------------------------------------------------------------------
...
class PfccAgentParamBuilder : public DgcObject {
   ...
   public:
    ...
    dgt_sint32 buildDirPttnParams(DgcMemRows* enc_job_tgt_id_rows) throw(
        DgcExcept);
    dgt_sint32 buildFilePttnParams(DgcMemRows* enc_job_tgt_id_rows) throw(
        DgcExcept);
    dgt_sint32 buildEncZoneParams(DgcMemRows* zone_id_rows) throw(DgcExcept);
    dgt_sint32 buildScheduleParams(dgt_sint64 schedule_date_id) throw(
        DgcExcept);
    dgt_sint32 buildJobParams(dgt_sint64 job_id) throw(DgcExcept);
    dgt_sint32 buildAgentParams(dgt_sint64 job_id,
                                dgt_sint64 schedule_id) throw(DgcExcept);
};
