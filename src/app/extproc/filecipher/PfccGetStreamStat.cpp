...
PfccGetStreamStat::PfccGetStreamStat(const dgt_schar* name, PfccAgentListener* agent_listener)
...
dgt_sint32 PfccGetStreamStat::initialize() throw(DgcExcept)
{
	return 0; 
}
...
dgt_sint32 PfccGetStreamStat::execute() throw(DgcExcept)
{
	...
	pcct_get_stream_stat_in* param_in = (pcct_get_stream_stat_in*)BindRows->data();
