...
PfccHasAgentSession::PfccHasAgentSession(const dgt_schar *name, PfccAgentListener *agent_listener)
...
dgt_sint32 PfccHasAgentSession::initialize() throw(DgcExcept)
{
	return 0;
}
...
dgt_sint32 PfccHasAgentSession::execute() throw(DgcExcept)
{
	...
	pfcc_has_agent_agent_session_in *stat_in = (pfcc_has_agent_agent_session_in *)BindRows->data();
	if (AgentSession)
...
dgt_sint32 PfccHasAgentSession::fetch() throw(DgcExcept)
{
	return 0;
}
