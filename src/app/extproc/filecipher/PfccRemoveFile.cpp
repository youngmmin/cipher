...
PfccRemoveFile::PfccRemoveFile(const dgt_schar* name,
...
dgt_sint32 PfccRemoveFile::initialize() throw(DgcExcept) { return 0; }
...
dgt_sint32 PfccRemoveFile::execute() throw(DgcExcept) {
    ...
    if (rm_file_path) {
        strncpy(rm_file_path, param_in->file_path,
