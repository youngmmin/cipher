...
class PetraCipherSchedule : public DgcPetraWorker {
   ...
   public:
    /**
     * The PCB_JOB_STATUS status value shares state information with the
     * PetraCipherJob class. The values of these two pieces of information must
     * always be identical.
     */
    ...
    PetraCipherSchedule(dgt_sint64 schedule_id, dgt_worker* wa,
                        dgt_sint64 job_id = 0);
