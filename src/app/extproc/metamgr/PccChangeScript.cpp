...
dgt_sint32 PccChangeScript::execute() throw(DgcExcept)
{
	...
	sprintf(sql_text,"delete pct_script where enc_tab_id=%lld and version_no=%d and step_no=%d and stmt_no=%d",
		InRow->enc_tab_id, InRow->version_no, InRow->step_no, InRow->stmt_no);
