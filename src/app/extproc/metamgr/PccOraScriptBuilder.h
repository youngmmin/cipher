...
class PccOraScriptBuilder : public PccScriptBuilder {
   ...
   protected:
   public:
    PccOraScriptBuilder(DgcDatabase* db, DgcSession* sess,
    ...
    dgt_schar* getFname(dgt_schar* col_name, dgt_uint8 fun_type,
    ...
    dgt_sint32 buildScript2(dgt_sint64 enc_tab_id,
                            dgt_uint16 version_no) throw(DgcExcept);
};
