...
********************************************************************/
#ifndef PCC_ORA_SCRIPT_BUILDER_H
#define PCC_ORA_SCRIPT_BUILDER_H
...
class PccOraScriptBuilder : public PccScriptBuilder {
  private:
	dgt_schar               fname[256];
	...
	dgt_sint32		insteadOfTrigger(dgt_sint8 is_final=0,dgt_sint32 uniq_flag=0) throw(DgcExcept);
  ...
  public:
	...
	PccOraScriptBuilder(DgcDatabase* db,DgcSession* sess,dgt_schar* schema_link);
	virtual ~PccOraScriptBuilder();
	...
	dgt_schar* getFname(dgt_schar* col_name,dgt_uint8 fun_type,dgt_uint8 instead_of_trigger_flag=0) throw(DgcExcept);

	virtual dgt_sint32 checkDB(dgt_sint64 db_agent_id,dgt_schar* sys_uid,dgt_schar* sys_pass,dgt_schar* agent_uid,DgcMemRows* rtn_rows) throw(DgcExcept);
	virtual dgt_sint32 setCharset(dgt_sint64 db_agent_id) throw(DgcExcept);
	virtual dgt_sint32 agentTest(dgt_sint64 db_agent_id,DgcMemRows* rtn_rows) throw(DgcExcept);
	virtual dgt_sint32 agentTableTest(dgt_sint64 db_agent_id,DgcMemRows* rtn_rows) throw(DgcExcept);
	...
	virtual dgt_sint32 buildScriptMig(dgt_sint64 enc_tab_id,dgt_uint16 version_no) throw(DgcExcept);
	virtual dgt_sint32 migInsertSql(dgt_sint64 it_tab_id, dgt_uint8 gen_flag=0) throw(DgcExcept);
	virtual dgt_sint32 runVerifyMig(dgt_sint64, pct_type_verify_job*) throw(DgcExcept);
	virtual dgt_sint32 buildScriptAddCol(dgt_sint64 enc_tab_id,dgt_uint16 version_no) throw(DgcExcept);
	virtual dgt_sint32 buildScriptColAdmin(dgt_sint64 enc_tab_id,dgt_uint16 version_no) throw(DgcExcept);
	virtual dgt_sint32 buildInstallScript(dgt_sint64 agent_id,dgt_schar* agent_uid,dgt_schar* agent_pass,dgt_schar* soha_home) throw(DgcExcept);
	dgt_sint32 buildScript2(dgt_sint64 enc_tab_id,dgt_uint16 version_no) throw(DgcExcept);
};
