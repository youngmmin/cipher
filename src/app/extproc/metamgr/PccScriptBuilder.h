...
class PccScriptBuilder : public DgcObject {
   ...
   protected:
    ...
    dgt_sint64 Dbid;
    virtual DgcCliConnection* connect(dgt_schar* uid,
                                      dgt_schar* pw) throw(DgcExcept) = 0;
   ...
   public:
    ...
    virtual dgt_sint32 checkDB(dgt_sint64 db_agent_id, dgt_schar* sys_uid,
                               ...
                               DgcMemRows* rtn_rows) throw(DgcExcept) = 0;
    ...
    virtual dgt_sint32 agentTest(dgt_sint64 db_agent_id,
                                 DgcMemRows* rtn_rows) throw(DgcExcept) = 0;
    virtual dgt_sint32 agentTableTest(
        dgt_sint64 db_agent_id, DgcMemRows* rtn_rows) throw(DgcExcept) = 0;

    inline DgcCliConnection* getConnection(dgt_schar* uid = 0,
    ...
    virtual dgt_sint32 buildScript(dgt_sint64 enc_tab_id,
                                   dgt_uint16 version_no) throw(DgcExcept) = 0;
    virtual dgt_sint32 buildScriptMig(
        dgt_sint64 enc_tab_id, dgt_uint16 version_no) throw(DgcExcept) = 0;
    virtual dgt_sint32 migInsertSql(
        dgt_sint64 it_tab_id, dgt_uint8 gen_flag = 0) throw(DgcExcept) = 0;
    virtual dgt_sint32 buildScriptAddCol(
        dgt_sint64 enc_tab_id, dgt_uint16 version_no) throw(DgcExcept) = 0;
    virtual dgt_sint32 buildScriptColAdmin(
        dgt_sint64 enc_tab_id, dgt_uint16 version_no) throw(DgcExcept) = 0;
    virtual dgt_sint32 runVerifyMig(dgt_sint64,
                                    pct_type_verify_job*) throw(DgcExcept) = 0;
    virtual dgt_sint32 buildInstallScript(
        dgt_sint64 agent_id, dgt_schar* agent_uid, dgt_schar* agent_pass,
        dgt_schar* soha_home) throw(DgcExcept) = 0;

    virtual dgt_sint32 getScript(dgt_sint64 enc_tab_id, dgt_uint16 version_no,
                                 dgt_sint16 step_no, dgt_sint16 stmt_no,
                                 DgcMemRows* rtn_rows = 0,
                                 dgt_uint8 comment_flag = 0) throw(DgcExcept);

    virtual dgt_sint32 runScript(const dgt_schar* script_text,
                                 DgcCliConnection* conn = 0) throw(DgcExcept);
    virtual dgt_sint32 runVerifyScript(dgt_schar* script_text,
