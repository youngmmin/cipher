...
class PccTds2000ScriptBuilder : public PccScriptBuilder {
  ...
  public:
	...
	PccTds2000ScriptBuilder(DgcDatabase* db,DgcSession* sess,dgt_schar* schema_link);
	...
	dgt_schar* getFname(dgt_sint64 enc_col_id,dgt_uint8 fun_type,dgt_uint8 instead_of_trigger_flag=0) throw(DgcExcept);
