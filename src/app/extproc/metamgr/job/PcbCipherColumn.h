...
class PcbCipherColumn : public PciCipherColumn {
   ...
   public:
    ...
    inline dgt_void setIdxColumnOrder(dgt_uint16 idx_column_order) {
        IdxColumnOrder = idx_column_order;
    };
    ...
    dgt_sint32 initializeIndexColumns(
        const pct_type_enc_column* enc_column,
        const pct_type_encrypt_key* enc_key,
    ...
    virtual dgt_sint32 decrypt(PcbDataColumn* data_column,
                               dgt_uint8 verify_flag = 0) throw(DgcExcept);

    dgt_uint32 ophuekLength(dgt_sint32 src_length, dgt_uint8 src_type);
    dgt_sint32 ophuek(PcbDataColumn* index_data_column,
