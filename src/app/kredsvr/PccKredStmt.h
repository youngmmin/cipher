...
class PccKredStmt : public DgcSqlStmt {
  ...
  protected:
	...
	dgt_sint32 getPrivilege(pc_type_get_priv_in* priv_in, pc_type_get_priv_out* priv_out,pct_type_priv_request_hist* rqst_hist);
  public:
	PccKredStmt(DgcPhyDatabase* pdb,DgcSession* session,DgcSqlTerm* stmt_term);
	virtual ~PccKredStmt();
