...
PccKredStmtGetTrailer::PccKredStmtGetTrailer(DgcPhyDatabase* pdb,
                                             DgcSession* session,
...
dgt_sint32 PccKredStmtGetTrailer::execute(
    ...
    v_bind.rewind();
    dg_sprintf(sql_text,
               "select trailer_size, trailer_char from PCT_ENCRYPT_KEY_TRAILER "
               "where key_id = :1");
    DgcSqlStmt* sql_stmt =
