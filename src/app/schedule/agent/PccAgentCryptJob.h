...
class PccAgentCryptJob : public DgcObject {
  ...
  protected:
  public:
	PccAgentCryptJob(dgt_sint64 job_id, dgt_sint32 trace_level, dgt_sint32 fail_file_queue_size = 200, dgt_sint32 nullity_file_queue_size = 200);
	...
	dgt_sint32 start(dgt_uint8 job_type,dgt_uint8 job_status,dgt_sint32 file_queue_size=0,dgt_sint32 collecting_interval=0) throw(DgcExcept);
