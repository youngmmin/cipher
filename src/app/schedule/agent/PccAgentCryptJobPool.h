...
class PccAgentCryptJobPool : public DgcObject {
  ...
  public:
	...
	inline dgt_void	setLastUpdate(dgt_sint64 last_update) { LastUpdate = last_update; };
	inline dgt_void	setFileQueueSize(dgt_sint32 file_queue_size) { FileQueueSize = file_queue_size; };
	inline dgt_void	setFailFileQueueSize(dgt_sint32 fail_file_queue_size) { FailFileQueueSize = fail_file_queue_size; };
	inline dgt_void	setNullityFileQueueSize(dgt_sint32 nullity_file_queue_size) { NullityFileQueueSize = nullity_file_queue_size; };
	inline dgt_void	setCollectInterval(dgt_sint32 interval) { CollectInterval = interval; };
