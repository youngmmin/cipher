...
class PccCipherAgentService : public DgcWorker {
   ...
   public:
    ...
    dgt_sint32 initialize(dgt_sint64 agent_id, dgt_schar* uds_listen_dir,
                          ...
                          dgt_sint32 max_use_cores, dgt_sint32 init_managers,
                          dgt_sint32 collect_interval,
                          dgt_sint32 no_sess_sleep_conunt,
                          dgt_sint32 trace_level, dgt_sint32 num_sessions,
    ...
    dgt_sint32 initialize(const dgt_schar* conf_file_path,
                          dgt_sint64 agent_id = 0) throw(DgcExcept);
