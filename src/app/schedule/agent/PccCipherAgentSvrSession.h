...
class PccCipherAgentSvrSession : public DgcWorker {
  ...
  protected:
  public:
	PccCipherAgentSvrSession(PccAgentCryptJobPool& job_pool, dgt_sint32 sess_id, dgt_sint32 no_sess_sleep_cnt, dgt_schar* p_ip, dgt_uint16 p_port, dgt_schar* s_ip=0, dgt_uint16 s_port=0);
