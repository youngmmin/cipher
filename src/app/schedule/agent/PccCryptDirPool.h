...
class PccCryptDirPool : public DgcObject {
   ...
   public:
    PccCryptDirPool(PccCryptZonePool& zone_pool, PccCryptSchedule& schedule,
    ...
    dgt_sint32 setCryptDir(dgt_sint64 dir_id, dgt_sint64 zone_id,
                           dgt_uint8 status, const dgt_schar* src_dir,
