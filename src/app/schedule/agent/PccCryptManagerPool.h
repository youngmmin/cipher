...
class PccCryptManagerPool : public DgcObject {
  ...
  public:
	...
	dgt_sint32 addManagers(dgt_sint32 num_managers=1, dgt_sint32 agent_mode=0, dgt_schar* enc_col_name=0, dgt_schar* header_flag=0, dgt_sint32 buffer_size=0, dgt_sint64 max_detection=10) throw(DgcExcept);
