...
class PccCryptMir : public DgcObject {
  private:
	...
	dgt_uint32	CheckSeq;	// check sequence which's increased by 1 every openDir()
  ...
  public:
	...
	dgt_void openMir() { if (ChangeFlag) CheckSeq++; }
	...
	dgt_void closeMir();
	PccCryptMir* findCryptMir(dgt_uint64 file_id,dgt_sint32 is_child_search=1);
