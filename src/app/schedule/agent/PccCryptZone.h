...
class PccCryptZone : public DgcObject {
  private:
	...
	dgt_sint64	SystemID;		// added by shson 2018.10.01 for CryptStat member variable, SystemID
	...
	dgt_sint32 lockExclusive(dgt_uint8 lock_type=ELF_TYPE_SET_PARAM) throw(DgcExcept);
  ...
  public:
	...
	// using zone parameters without shared lock because they are not critical parameters in file cryption
	...
	dgt_sint32 setZoneParams(DgcBgrammer* bg,dgt_schar* err_string) throw(DgcExcept);
	dgt_sint32 setKeyParams(DgcBgrammer* bg,dgt_schar* err_string) throw(DgcExcept);
	dgt_sint32 setRegularParams(DgcBgrammer* bg,dgt_schar* err_string) throw(DgcExcept);
	dgt_sint32 setDelimiterParams(DgcBgrammer* bg,dgt_schar* err_string) throw(DgcExcept);
	dgt_sint32 setFixedParams(DgcBgrammer* bg,dgt_schar* err_string) throw(DgcExcept);
	dgt_sint32 setSystemInfoParams(DgcBgrammer* bg,dgt_schar* err_string) throw(DgcExcept);

	// using zone parameters
	dgt_sint32 buildParam(dgt_schar* buf,dgt_uint32* buf_len, dgt_sint32 migration_flag = 0) throw(DgcExcept);
