...
PccGetAgentInfoStmt::PccGetAgentInfoStmt(PccAgentCryptJobPool& job_pool, dgt_sint32 sess_id)
...
dgt_sint32 PccGetAgentInfoStmt::execute(DgcMemRows* mrows, dgt_sint8 delete_flag) throw(DgcExcept)
{
	IsExecuted = 1;
