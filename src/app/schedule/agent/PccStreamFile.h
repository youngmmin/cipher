...
class PccStreamFile : public DgcObject {
	...
	public:
		...
		inline dgt_void setSrcFileSize(dgt_sint64 src_file_size) { SrcFileSize = src_file_size; };
		inline dgt_void setDstFileSize(dgt_sint64 dst_file_size) { DstFileSize = dst_file_size; };
