...
#if !defined(PCI_DES_PTR) && !defined(PCI_DES_RISC1) && \
    !defined(PCI_DES_RISC2) && !defined(PCI_DES_UNROLL)
...
#define pci_c2l(c, l)                                                       \
    (l = ((PCI_DES_LONG)(*((c)++))), l |= ((PCI_DES_LONG)(*((c)++))) << 8L, \
...
#define PCI_LOAD_DATA_tmp(R, S, u, t, E0, E1)   \
    {                                           \
        PCI_DES_LONG tmp;                       \
        PCI_LOAD_DATA(R, S, u, t, E0, E1, tmp); \
    }
...
#define PCI_ENCRYPT(LL, R, S)                                                 \
    {                                                                         \
        ...
        LL ^=                                                                 \
            ...
            *(PCI_DES_LONG *)((unsigned char *)des_SP + 0x200 +               \
                              ((u >> 8L) & 0xfc)) ^                           \
            *(PCI_DES_LONG *)((unsigned char *)des_SP + 0x400 +               \
                              ((u >> 16L) & 0xfc)) ^                          \
            *(PCI_DES_LONG *)((unsigned char *)des_SP + 0x600 +               \
                              ((u >> 24L) & 0xfc)) ^                          \
            *(PCI_DES_LONG *)((unsigned char *)des_SP + 0x100 + ((t)&0xfc)) ^ \
            *(PCI_DES_LONG *)((unsigned char *)des_SP + 0x300 +               \
                              ((t >> 8L) & 0xfc)) ^                           \
            *(PCI_DES_LONG *)((unsigned char *)des_SP + 0x500 +               \
                              ((t >> 16L) & 0xfc)) ^                          \
            *(PCI_DES_LONG *)((unsigned char *)des_SP + 0x700 +               \
                              ((t >> 24L) & 0xfc));                           \
    }
#endif
...
#define PCI_ENCRYPT(LL, R, S)                         \
    {                                                 \
        PCI_LOAD_DATA_tmp(R, S, u, t, E0, E1);        \
        t = PCI_ROTATE(t, 4);                         \
        LL ^= pci_des_SPtrans[0][(u >> 2L) & 0x3f] ^  \
...
#define PCI_HPERM_OP(a, t, n, m)                \
    ((t) = ((((a) << (16 - (n))) ^ (a)) & (m)), \
     (a) = (a) ^ (t) ^ (t >> (16 - (n))))

static dgt_sint32 shifts2[16] = {0, 0, 1, 1, 1, 1, 1, 1,
                                 0, 1, 1, 1, 1, 1, 1, 0};

dgt_sint32 Pci3DesCipher::desSetKey(const dgt_schar *key,
                                    pci_des_key_schedule schedule) {
...
dgt_void Pci3DesCipher::desEncrypt2(PCI_DES_LONG *data, pci_des_key_schedule ks,
                                    dgt_sint32 encrypt) {
...
Pci3DesCipher::Pci3DesCipher() { BlockBytes = 8; }
