...
class PciCipherFactory {
  ...
  protected:
  public:
	PciCipherFactory() : AriaCipher(0), SeedCipher(0), Seed256Cipher(0), AesCipher(0), TDesCipher(0), DesCipher(0), ShaCipher(0), HmacCipher(0), HightCipher(0), LeaCipher(0) {}
	...
	inline PciCipher* getCipher(dgt_uint8 cipher_type,dgt_uint16 key_size,dgt_uint8 lib_type=CIPHER_LIB_PETRA)
	{
