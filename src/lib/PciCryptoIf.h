...
class PCI_Context {
   public:
    ...
    dgt_uint8 pad_type;  // 0,1 : zero 2 : pkcs#5,7 3: pkcs #5,7 + user defined
                         // trailer
...
dgt_sint32 PCI_initContext(PCI_Context* ctx, const dgt_uint8* key,
                           ...
                           dgt_uint8 enc_mode, dgt_uint8 iv_type = 0,
                           dgt_uint8 n2n_flag = 0,
                           dgt_uint8 b64_txt_enc_flag = 0,
                           dgt_uint8 enc_start_pos = 1,
                           dgt_uint32 enc_length = 0, dgt_uint8 oph_flag = 0,
...
dgt_sint32 PCI_OPHUEK(PCI_Context* ctx, dgt_uint8* src, dgt_sint32 src_len,
                      dgt_uint8* dst, dgt_uint32* dst_len,
                      dgt_sint64 enc_col_id, dgt_uint8 src_type,
                      dgt_sint32 src_enc_flag = 1, dgt_sint32 b64_flag = 0);
