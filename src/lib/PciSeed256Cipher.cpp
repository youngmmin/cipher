...
#define seed_char2word(c, i)  \
        (i) = ((((dgt_uint32)(c)[0]) << 24) | (((dgt_uint32)(c)[1]) << 16) | (((dgt_uint32)(c)[2]) << 8) | ((dgt_uint32)(c)[3]))
...
void PciSeed256Cipher::SeedEncRoundKey(dgt_uint32 *pdwRoundKey,dgt_uint8 *pbUserKey)
{
...
dgt_sint32 PciSeed256Cipher::encryptBlock(dgt_uint8 *iblock,dgt_uint8* oblock)
{
...
dgt_sint32 PciSeed256Cipher::decryptBlock(dgt_uint8 *iblock,dgt_uint8* oblock)
{
	memcpy(oblock,iblock,BlockBytes);
