...
class PcaKeySvrSession : public DgcObject {
   ...
   public:
    ...
    virtual dgt_sint32 getKey(dgt_sint64 key_id,
                              pc_type_get_key_out* key_out) = 0;

    virtual dgt_sint32 getIV(dgt_uint8 iv_type, dgt_uint16 iv_size,
                             pc_type_get_iv_out* iv_out) = 0;

    virtual dgt_sint32 alert(pc_type_alert_in* alert_request) = 0;

    virtual dgt_sint32 approve(dgt_sint64 user_sid, dgt_sint64 enc_col_id,
                               dgt_sint64 approve_id, dgt_sint32* result) = 0;
    ...
    virtual dgt_sint32 encrypt(dgt_sint64 enc_col_id, dgt_uint8* src,
                               dgt_sint32 src_len, dgt_uint8* dst,
                               dgt_uint32* dst_len, dgt_sint32 ksv_num) = 0;
    ...
    virtual dgt_sint32 logUserFileRequest(
        pc_type_user_file_request_in* log_request) = 0;

    virtual dgt_sint32 getZoneParam(dgt_sint64 zone_id, dgt_schar* param) = 0;
    virtual dgt_sint32 getRegEngine(dgt_sint64 reg_engine_id,
                                    dgt_schar* param) = 0;
    virtual dgt_sint32 getCryptParam(dgt_schar* crypt_param_name,
                                     dgt_schar* param) = 0;
    virtual dgt_sint32 logDetectFileRequest(
        pc_type_detect_file_request_in* log_request, DgcMemRows* log_data) = 0;
    virtual dgt_sint32 getDetectFileRequest(DgcMemRows* get_request) = 0;
    virtual dgt_sint32 getRsaKey(dgt_schar* key_name,
                                 dgt_schar* key_string) = 0;
};
