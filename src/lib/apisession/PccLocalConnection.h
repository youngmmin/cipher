...
class PccLocalConnection : public DgcCliConnectionImpl {
  ...
  protected:
  public:
	PccLocalConnection(dgt_uint16 in_timeout,dgt_uint16 out_timeout,dgt_uint32 max_open_cursors=DGC_MAX_OPEN_CURSORS);
	virtual ~PccLocalConnection();

	virtual dgt_sint8 connect(dgt_schar*		shome,		// database home
