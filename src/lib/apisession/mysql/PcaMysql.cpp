...
{
#ifdef WIN32
	__declspec(dllexport) my_bool pls_opnsess_init(UDF_INIT *initid, UDF_ARGS *args, char *message)
#else
...
#ifdef WIN32
	__declspec(dllexport) double pls_opnsess(UDF_INIT *initid, UDF_ARGS *args, char *is_null, char *error)
#else
...
#endif
	{
		...
		if (inet_aton(args->args[2], &addr.sin_addr) == 0)
		{
			...
			{
				strncpy(ip_address, inet_ntoa(*(struct in_addr *)host->h_addr_list[0]), 32);
			}
		}
...
#ifdef WIN32
	__declspec(dllexport) my_bool pls_encrypt_init(UDF_INIT *initid, UDF_ARGS *args, char *message)
#else
	...
	__declspec(dllexport) char *pls_encrypt(UDF_INIT *initid, UDF_ARGS *args,
											...
											char *error)
#else
	char *pls_encrypt(UDF_INIT *initid, UDF_ARGS *args,
					  char *result, unsigned long *res_length, char *null_value,
					  char *error)
#endif
	{
		...
		{
			//		if ((ret=session->encrypt(enc_col_id,(dgt_uint8*)src_buf,src_len,enc_buf,&dst_len)) < 0 ) {
			if ((ret = PcAPI_encrypt(sid, enc_col_id, (dgt_uint8 *)src_buf, src_len, enc_buf, &dst_len)) < 0)
			{
				if (ret == -30301)
				{
...
#ifdef WIN32
	__declspec(dllexport) my_bool pls_encrypt_name_init(UDF_INIT *initid, UDF_ARGS *args, char *message)
#else
	...
	__declspec(dllexport) char *pls_encrypt_name(UDF_INIT *initid, UDF_ARGS *args,
												 ...
												 char *error)
#else
	char *pls_encrypt_name(UDF_INIT *initid, UDF_ARGS *args,
						   char *result, unsigned long *res_length, char *null_value,
						   char *error)
#endif
	{
		...
		{
			// if ((ret=session->encrypt(enc_col_name,(dgt_uint8*)src_buf,src_len,enc_buf,&dst_len)) < 0 ) {
			if ((ret = PcAPI_encrypt_name(sid, enc_col_name, (dgt_uint8 *)src_buf, src_len, enc_buf, &dst_len)) < 0)
			{
				if (ret == -30301)
				{
					strmov(ret_buf, "petra_reject");
...
#ifdef WIN32
	__declspec(dllexport) my_bool pls_decrypt_init(UDF_INIT *initid, UDF_ARGS *args, char *message)
#else
	...
	__declspec(dllexport) char *pls_decrypt(UDF_INIT *initid, UDF_ARGS *args,
											...
											char *error)
#else
	char *pls_decrypt(UDF_INIT *initid, UDF_ARGS *args,
					  char *result, unsigned long *res_length, char *null_value,
					  char *error)
#endif
	{
		...
		{
			// if ((ret=session->decrypt(enc_col_id,(dgt_uint8*)src_buf,src_len,dec_buf,&dst_len)) < 0 ) {
			if ((ret = PcAPI_decrypt(sid, enc_col_id, (dgt_uint8 *)src_buf, src_len, dec_buf, &dst_len)) < 0)
			{
				if (ret == -30401)
				{
					strmov(ret_buf, "petra_reject");
...
#ifdef WIN32
	__declspec(dllexport) my_bool pls_decrypt_name_init(UDF_INIT *initid, UDF_ARGS *args, char *message)
#else
	...
	__declspec(dllexport) char *pls_decrypt_name(UDF_INIT *initid, UDF_ARGS *args,
												 ...
												 char *error)
#else
	char *pls_decrypt_name(UDF_INIT *initid, UDF_ARGS *args,
						   char *result, unsigned long *res_length, char *null_value,
						   char *error)
#endif
	{
		...
		{
			// if ((ret=session->decrypt(enc_col_name,(dgt_uint8*)src_buf,src_len,dec_buf,&dst_len)) < 0 ) {
			if ((ret = PcAPI_decrypt_name(sid, enc_col_name, (dgt_uint8 *)src_buf, src_len, dec_buf, &dst_len)) < 0)
			{
				if (ret == -30401)
				{
					strmov(ret_buf, "petra_reject");
...
#ifdef WIN32
	__declspec(dllexport) my_bool pls_l_encrypt_init(UDF_INIT *initid, UDF_ARGS *args, char *message)
#else
	...
	__declspec(dllexport) char *pls_l_encrypt(UDF_INIT *initid, UDF_ARGS *args,
											  ...
											  char *error)
#else
	char *pls_l_encrypt(UDF_INIT *initid, UDF_ARGS *args,
						char *result, unsigned long *res_length, char *null_value,
						char *error)
#endif
	{
...
#ifdef WIN32
	__declspec(dllexport) my_bool pls_l_encrypt_name_init(UDF_INIT *initid, UDF_ARGS *args, char *message)
#else
	...
	__declspec(dllexport) char *pls_l_encrypt_name(UDF_INIT *initid, UDF_ARGS *args,
												   ...
												   char *error)
#else
	char *pls_l_encrypt_name(UDF_INIT *initid, UDF_ARGS *args,
							 char *result, unsigned long *res_length, char *null_value,
							 char *error)
#endif
	{
...
#ifdef WIN32
	__declspec(dllexport) my_bool pls_l_decrypt_init(UDF_INIT *initid, UDF_ARGS *args, char *message)
#else
	...
	__declspec(dllexport) char *pls_l_decrypt(UDF_INIT *initid, UDF_ARGS *args,
											  ...
											  char *error)
#else
	char *pls_l_decrypt(UDF_INIT *initid, UDF_ARGS *args,
						char *result, unsigned long *res_length, char *null_value,
						char *error)
#endif
	{
...
#ifdef WIN32
	__declspec(dllexport) my_bool pls_l_decrypt_name_init(UDF_INIT *initid, UDF_ARGS *args, char *message)
#else
	...
	__declspec(dllexport) char *pls_l_decrypt_name(UDF_INIT *initid, UDF_ARGS *args,
												   ...
												   char *error)
#else
	char *pls_l_decrypt_name(UDF_INIT *initid, UDF_ARGS *args,
							 char *result, unsigned long *res_length, char *null_value,
							 char *error)
#endif
	{
